...
from performance_ledger import LEDGER_COLUMNS, update_performance_ledger
...
def test_missing_source_state_is_not_an_official_freeze(tmp_path):
    write(pd.DataFrame([frozen_row(final_pregame_state_at_utc="")]), tmp_path / "live_recent.csv")
