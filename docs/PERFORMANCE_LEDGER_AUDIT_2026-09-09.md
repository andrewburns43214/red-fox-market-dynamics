...
The service failed before writing, so no ledger classification was created or altered. The local compatibility correction is covered by an explicit all-missing timestamp test; the maintained suite now reports **462 passed and 17 subtests passed**. Per the deployment gate, no second deployment was attempted in this turn.
